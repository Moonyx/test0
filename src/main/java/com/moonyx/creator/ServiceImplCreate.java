...
public class ServiceImplCreate {

	public static void create(String targetFolderPath, List<Field> fields) {
		String packageName = Creator.classFullName.replace("entity." + Creator.className, "service.impl");
		
		File serviceImplModel = new File(Creator.modelPath + "serviceImpl.java");
		File serviceFile = new File(targetFolderPath + Creator.className + "ServiceImpl.java");
		BufferedReader reader = null;
		FileWriter fw = null;
		BufferedWriter writer = null;
		try {
			reader = new BufferedReader(new FileReader(serviceImplModel));
