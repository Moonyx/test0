...
public class HttpClientUtil {
	...
	private static HttpClientUtil httpClientHelper = null;
	...
	private static synchronized void syncInit() {
		if (httpClientHelper == null) {
			httpClientHelper = new HttpClientUtil();
		}
	}
	...
	public CloseableHttpClient getConnection() {
		...
		httpClientBuilder.setConnectionManager(poolConnManager)
				.setDefaultRequestConfig(requestConfig);// set proxy
		if (proxyIp != null) {
	...
	public CloseableHttpClient getConnection(String url) {
		CloseableHttpClient closeableHttpClient = null;
		if (url != null && url.startsWith("https")) {
			closeableHttpClient = HttpsSSLClient.createSSLInsecureClient();
        } else {
	...
	public String doGet(String url, Map<String, String> params) {
		...
		log.info(apiUrl);
		String result = null;
		CloseableHttpClient httpClient = getConnection(url);
